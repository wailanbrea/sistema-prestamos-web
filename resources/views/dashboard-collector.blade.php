...
@section('content')
    ...
    <section class="row g-3 mb-4">
        ...
        <div class="col-6 col-lg-3"><div class="card content-card h-100"><div class="card-body"><div class="text-muted small text-uppercase">Capital asignado</div><div class="fs-5 fw-bold text-primary">{{ currency() }} {{ number_format($metrics['remaining_balance'], 2) }}</div></div></div></div>
    </section>
                ...
                <div class="card-body pt-2">
                    <div class="table-responsive">
                        <table class="table align-middle mb-0">
                            <thead><tr><th>Préstamo</th><th>Cliente</th><th>Estado</th><th class="text-end">Capital pendiente</th></tr></thead>
                            <tbody>
