                    ...
                    <form method="POST" action="{{ route('accounts-payable.store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    <input id="interest_rate_visual" type="number" step="0.0001" min="0" value="{{ old('interest_rate') }}" class="form-control @error('interest_rate') is-invalid @enderror" required>
                                    <input type="hidden" id="interest_rate" name="interest_rate" value="{{ old('interest_rate') }}">
...
<script>
    (function () {
        ...
        const currentCurrency = () => currency?.value || @json(account_payable_default_currency());
