            ...
            <form method="POST" action="{{ route('loans.update', $loan) }}" novalidate>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <div class="input-group">
                            <input id="interest_rate_visual" type="number" step="0.01" min="0" value="{{ old('interest_rate', $fmtRate($loan->interest_rate)) }}" class="form-control @error('interest_rate') is-invalid @enderror" {{ $disabled }}>
                            <input type="hidden" id="interest_rate" name="interest_rate" value="{{ old('interest_rate', $fmtRate($loan->interest_rate)) }}">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select id="calculation_method" name="calculation_method" class="form-select @error('calculation_method') is-invalid @enderror" {{ $disabled }}>
                            @php
                                ...
                                if (! isset($editableMethodLabels[$loan->calculation_method])) {
                                    $editableMethodLabels[$loan->calculation_method] = ($methodLabels[$loan->calculation_method] ?? $loan->calculation_method).' (actual)';
                                }
                            @endphp
