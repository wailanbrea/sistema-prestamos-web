...
trait BuildsApiPayloads
{
    ...
    protected function paymentPayload(Payment $payment): array
    {
        return [
            ...
            'capital_prepaid' => (float) $payment->capital_prepaid,
            ...
            'target_installment_id' => $payment->target_installment_id,
            'target_installment_number' => $payment->targetInstallment?->installment_number,
            'excess_action' => $payment->excess_action,
